    ...
    try {
      ...
      if (emailChanged) {
        try {
          ...
          if (error.code === "auth/operation-not-allowed") {
            ...
            emailWarning =
              " Email was saved in Firestore only, because Firebase auth email change is not enabled in this demo.";
          } else {
            throw error;
          }
        }
      ...
      showAlert(
        ...
        authEmailUpdated
          ...
          : "Profile updated successfully in Firestore only. Firebase auth email change is not enabled in this demo.",
      );
    } catch (error) {
      ...
      if (error.code === "auth/wrong-password")
        ...
        message =
          "Unable to update the auth email. The project is running in demo mode.";
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.hint}>
          Change your email here. Just enter your password and save to update it
          for the demo.
        </Text>
